...
export default {
    ...
    async join (store, {user_id, user_pw, user_name, phone_num, zip_code,addr,detail_address}) {
        let joinResponse = await joinAPI.doJoin(user_id, user_pw, user_name,phone_num, zip_code,addr,detail_address)
